        ...
        <main style={{
            ...
            <Container maxWidth="lg" style={{paddingRight : '128px', paddingLeft : '128px',justifyContent: 'center', display : 'flex', height : '100vh', alignItems : 'center'}}>
                ...
                <FormControl sx={{display : 'flex', flexDirection : 'column'}}>
                    ...
                    <input style={{backgroundColor : 'white',borderRadius : '4px', borderWidth : '0px', color : 'black', height : '48px', width : '100%', padding: '8px',fontFamily : montserrat.style.fontFamily, fontSize : '16px', fontWeight : 500}} id="outlined-basic"   />
                    </Box>
                    
                    <Box sx={{marginBottom : '16px'}}>
                    <Typography variant='body1' fontWeight={500} marginBottom={'8px'}>Password</Typography>

                    <input  style={{backgroundColor : 'white', borderRadius : '4px',borderWidth : '0px', color : 'black', marginBottom : '8px', height : '48px',  width : '100%', fontFamily : montserrat.style.fontFamily,padding: '8px', fontSize : '16px', fontWeight : 500}} id="outlined-basic"  type='password'  />
                    </Box>

                    <Button sx={{backgroundColor : "#0F172A", height : '48px'}} variant="contained">
